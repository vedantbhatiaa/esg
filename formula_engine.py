...
Changes (v1 hardening):
- M1: Fixed waste validation check (was a tautology — always passed)
- M4: SCOPE2_ELEC_EF is now a configurable TemplateInputs field with a
      regional-default fallback; hardcoded global still kept as the default
